...
<div class="wrap">
	...
	<div id="icon-tools" class="icon32"><br></div><?php echo "<h2>".sprintf(__('%s - Settings', post_grid_textdomain), post_grid_plugin_name)."</h2>";?>
    ...
    <div class="para-settings post-grid-settings">
		...
		<ul class="box">
            ...
            <li style="display: block;" class="box2 tab-box active">
                ...
                <div class="option-box">
                    <p class="option-title"><?php _e('FAQ', post_grid_textdomain); ?></p>
                    ...
                    $faq =  $class_post_grid_functions->faq();

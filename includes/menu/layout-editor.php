...
<div class="wrap">
	...
	<div id="icon-tools" class="icon32"><br></div><?php echo "<h2>".sprintf(__('%s - Layout Editor', post_grid_textdomain), post_grid_plugin_name)."</h2>";?>
		...
		<div class="layout-editor post-grid-layout-editor para-settings">
            ...
            foreach($layout_items as $item_key=>$item_info){
                
                ?>
                <div class="item" layout="<?php echo $layout_content; ?>" item_key="<?php echo $item_key; ?>" ><i class="fa fa-plus"></i> <?php echo $item_info['name']; ?></div>
                <?php
            ...
            <?php if(isset($_GET['layout_content'])) {?>
                <div class="idle  ">
                <div class="name"><?php echo __('Content:', post_grid_textdomain); ?> <?php echo $layout_content; ?></div>     
            ...
            <div class="css-editor expandable">
				...
				$layout_content_list = $class_post_grid_functions->layout_content_list();
                    ...
                    <option value="create-new"><?php echo __('Create New' , post_grid_textdomain); ?></option>
						<?php
					...
					foreach($layout as $key=>$items){
                        ...
                        <div class="items" id="<?php echo $key; ?>">
                        	...
                        	<div class="header">
                            	<span class="remove pg-tooltip" title="<?php echo __('Remove', post_grid_textdomain); ?>"><i class="fa fa-times"></i></span>
                                <span class="move pg-tooltip" title="<?php echo __('Move', post_grid_textdomain); ?>"><i class="fa fa-bars"></i></span>
                                <span class="expand pg-tooltip" title="<?php echo __('Expand or collapse', post_grid_textdomain); ?>">
	...
	<br />
                                    ...
                                    <a target="_blank" href="http://www.pickplugins.com/demo/post-grid/sample-css-for-layout-editor/"><?php _e('Sample css', post_grid_textdomain ); ?></a><br />
									<textarea autocorrect="off" autocapitalize="off" spellcheck="false"  style="width:50%" class="custom_css" item_id="<?php echo $key; ?>" name="post_grid_layout_content[<?php echo $layout_content; ?>][<?php echo $i; ?>][<?php echo $item_key; ?>]"><?php echo str_replace(array("\n", "\r"), '', $item_info); ?></textarea><br />
								...
								<br />
									...
									<textarea autocorrect="off" autocapitalize="off" spellcheck="false"  style="width:50%" class="custom_css" item_id="<?php echo $items['key']; ?>" name="post_grid_layout_content[<?php echo $layout_content; ?>][<?php echo $i; ?>][<?php echo $item_key; ?>]"><?php echo str_replace(array("\n", "\r"), '', $item_info); ?></textarea><br />
								...
								elseif($item_key=='char_limit'){
										?>
                                        	...
                                        	<?php _e('Word limit:', post_grid_textdomain ); ?> <br />
								...
								elseif($item_key=='taxonomy'){
										?>
                                        	...
                                        	<?php _e('Taxonomy:', post_grid_textdomain ); ?> <br />
								...
								elseif($item_key=='taxonomy_term_count'){
										?>
                                        	...
                                        	<?php _e('Term count:', post_grid_textdomain ); ?> <br />

...
function post_grid_post_settings_input( $post ) {
	...
	if(!empty($post_grid_post_settings['thumb_custom_url'])){
		$thumb_custom_url = $post_grid_post_settings['thumb_custom_url'];
		}
	else{
		$thumb_custom_url = '';
		}	
	...
	if(!empty($post_grid_post_settings['custom_video_MP4'])){
		$custom_video_MP4 = $post_grid_post_settings['custom_video_MP4'];
		}
	else{
		$custom_video_MP4 = '';
	}

	if(!empty($post_grid_post_settings['custom_video_OGV'])){
		$custom_video_OGV = $post_grid_post_settings['custom_video_OGV'];
		}
	else{
		$custom_video_OGV = '';
	}
	...
	if(!empty($post_grid_post_settings['custom_video_WEBM'])){
		$custom_video_WEBM = $post_grid_post_settings['custom_video_WEBM'];
		}
	else{
		$custom_video_WEBM = '';
	}
		...
		<ul class="box">
            <li style="display: block;" class="box1 tab-box active">
                <div class="option-box">
                    ...
                    <option value="" <?php if($post_skin=='') echo "selected"; ?>><?php echo __('None', post_grid_textdomain); ?></option>
                    	<?php
                ...
                <div class="option-box">
                    <p class="option-title"><?php _e('Thumbnail custom URL', post_grid_textdomain); ?></p>
                    <p class="option-info"></p>
					<input type="text" name="post_grid_post_settings[thumb_custom_url]" value="<?php echo $thumb_custom_url; ?>" />
            ...
            <li style="display: none;" class="box2 tab-box">
                ...
                <div class="option-box">
                    ...
                    <p class="option-info"><?php sprintf(_e('Font awesome icon id, ex: <b>fa-share-alt</b> , please check font awesome incon here <a href="%s">%s</a>', 'http://fortawesome.github.io/Font-Awesome/icons/', 'http://fortawesome.github.io/Font-Awesome/icons/') ); ?></p>
            ...
            <li style="display: none;" class="box3 tab-box">
                ...
                <div class="option-box">
                    ...
                    <p class="option-info"><?php _e('Custom Audio', post_grid_textdomain); ?></p>
                    ...
                    <p class="option-title"><?php _e('Custom Video', post_grid_textdomain); ?></p>
                    <p class="option-info"><?php _e('Custom MP4', post_grid_textdomain); ?></p>
                    <input placeholder="237668695" type="text" name="post_grid_post_settings[custom_video_MP4]" value="<?php echo $custom_video_MP4; ?>" />                     
                    
                    <p class="option-info"><?php _e('Custom OGV', post_grid_textdomain); ?></p>
                    <input placeholder="237668695" type="text" name="post_grid_post_settings[custom_video_OGV]" value="<?php echo $custom_video_OGV; ?>" /> 
                    
                    <p class="option-info"><?php _e('Custom WEBM', post_grid_textdomain); ?></p>
                    <input placeholder="237668695" type="text" name="post_grid_post_settings[custom_video_WEBM]" value="<?php echo $custom_video_WEBM; ?>" />                     

	...
	elseif($post_format=='gallery')
	...
	else
		{
				...
				if($post_grid_hover_items_zoom_display == 'yes')
					{
						$html_hover .= '<a title="'.__('Zoom.', post_grid_textdomain).'" class="zoom"></a>';
					}
				
				if($post_grid_hover_items_link_display == 'yes')
					{
						$html_hover .= '<a title="'.__('Read More.', post_grid_textdomain).'" href="'.get_the_permalink(get_the_ID()).'" class="post-link"></a>';
					}								
